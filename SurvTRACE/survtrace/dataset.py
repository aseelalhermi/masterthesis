from pycox.datasets import metabric, nwtco, support, gbsg
...
def load_data(config):
    ...
    return (
         df_all, X_train, df_y_train_trans, X_test, df_y_test_raw, X_val, df_y_val_trans, df_y_val_raw, X_temp, df_y_trainval_trans, df_y_trainval_raw, y_temp_trans, df_trainval
    )